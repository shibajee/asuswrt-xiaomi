...
{
#if defined (CONFIG_GE_RGMII_INTERNAL_P0_AN) || defined (CONFIG_GE_RGMII_INTERNAL_P4_AN) || defined (CONFIG_GE_RGMII_INTERNAL_P1_AN)
...
#elif defined (CONFIG_GE_RGMII_INTERNAL_P4_AN) || defined (CONFIG_GE_RGMII_INTERNAL_P1_AN)
